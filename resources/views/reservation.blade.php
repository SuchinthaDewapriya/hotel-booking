@extends('layouts.app')
@section('title', 'Room Reservation | Secret Paradise Villa')
@section('meta')
<meta name="description" content="Check room availability and make reservations at Secret Paradise Villa in Sri Lanka. Book your stay at our luxury villa with stunning views of Hiriketiya Beach.">
<meta name="keywords" content="Room reservation Secret Paradise Villa, Sri Lanka villa booking, check room availability, villa reservation online, Hiriketiya Beach accommodation">
@endsection

@section('content') 
<section class="reservation-page py-25">
    <div class="container">

        <div class="text-center mb-3" data-aos="fade-up">
            <h1 class="page-title text-center mt-5">Room Reservations</h1>
            <p class="text-center">
                Check room availability and make reservations at Secret Paradise Villa in Sri Lanka. Book your stay at our luxury villa with stunning views of Hiriketiya Beach.
            </p>
        </div>
            ...
            <div class="gtco-container">
                <div class="row" data-aos="fade-up">
                                    ...
                                    <div class="tab">
                                        <div class="tab-content">
                                            <div class="tab-content-inner active" data-content="signup">
                                                <h2 class="">Check Availability</h2>
                                                <form id="checkForm">
                                                    @csrf
                                                    ...
                                                    <div class="row form-group"> 
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="date" name="checkIn" id="checkIn" min="<?php echo date('Y-m-d'); ?>" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="date-start">Departure*</label>
                                                            <input type="date" name="checkOut" id="checkOut" min="<?php echo date('Y-m-d'); ?>"  class="form-control" required>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <input type="button" onClick="Check()" class="btn btn-book btn-block" value="Check">
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                {{-- <div class="cart">
                                    ...
                                    <div id="cart-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ${{$cartContent['price']}} x {{$cartContent['attributes']->days}} days
                                            </div>
                                            <div class="col-md-4">
                                                @php
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="rooms p-5">
                            <div class="alert alert-warning">Please select arrival date and departure date to check the rooms availability.</div>
                        </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response.checkRoom, function(k,v){
                    ...
                    if (v.gallery_image_1 != 0) {
                        Slide1 = '<div class="carousel-item active slide1'+v.r_id+'"><img class="d-block w-100" src="{{ asset('public/images/rooms')}}/'+v.gallery_image_1+'" alt="1 slide"></div>'
                    }
                    if (v.gallery_image_2 != 0) {
                        Slide2 = '<div class="carousel-item slide2'+v.r_id+'"><img class="d-block w-100" src="{{ asset('public/images/rooms')}}/'+v.gallery_image_2+'" alt="2 slide"></div>'
                    }
                    if (v.gallery_image_3 != 0) {
                        Slide3 = '<div class="carousel-item slide3'+v.r_id+'"><img class="d-block w-100" src="{{ asset('public/images/rooms')}}/'+v.gallery_image_3+'" alt="3 slide"></div>'
                    }
                    if (v.gallery_image_4 != 0) {
                        Slide4 = '<div class="carousel-item slide4'+v.r_id+'"><img class="d-block w-100" src="{{ asset('public/images/rooms')}}/'+v.gallery_image_4+'" alt="4 slide"></div>'
                    }
                    if (v.gallery_image_5 != 0) {
                        Slide5 = '<div class="carousel-item slide5'+v.r_id+'"><img class="d-block w-100" src="{{ asset('public/images/rooms')}}/'+v.gallery_image_5+'" alt="5 slide"></div>'
                    }
                    var roomFirstPrice = v.r_price * response.days
                    $('.rooms').append('<form id="CartForm" method="POST" action="{{ url('/confirm-order')}}">@csrf<div class="card reservation-card"><div class="card-body"><div class="card reservation-card1"><div class="card-body"><div class="row"><div class="col-md-5"><div id="RoomSlider'+v.r_id+'" class="carousel slide" data-ride="carousel"><div class="carousel-inner">'
                        +Slide1 + Slide2 + Slide3 + Slide4 + Slide5+'</div><a class="carousel-control-prev" href="#RoomSlider'+v.r_id+'" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#RoomSlider'+v.r_id+'" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div></div><div class="col-md-7"><h2 class="room-name">'
                        ...
                        +v.r_id+')" class="btn btn-book float-right">Reserve</button></div></div></div></form>')
                    } else {
    ...
    function roomQuantityChange(id, price, bedRate){
      ...
      if (roomQty[id] > 0) { 
          ...
          for (i = 0; i < roomQty[id]; i++) {
              $(".rooms .NewBed"+id).append('<div class="col-md-4" style="padding:5px;"><div class="custom-control custom-checkbox mr-sm-2"><input type="checkbox" class="custom-control-input additionalbedquantity'+i+'" name="bed[]" value="1" onchange="addBeds('+i+','+bedRate+',this, '+id+')" id="additionalbedquantity'+(i+1)+id+'" placeholder="Room number '+(i+1)+'"><label class="custom-control-label" for="additionalbedquantity'+(i+1)+id+'">Room number '+(i+1)+'</label></div></div>')
          }
